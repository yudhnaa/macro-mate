...
class UserProfileBase(BaseModel):
    ...
    body_shape: Optional[str] = Field(None, description="Dáng người: gầy, bình thường, mập, béo phì")
    health_conditions: Optional[str] = Field(None, description="Các bệnh lý hiện có")
    fitness_goal: Optional[str] = Field(None, description="Mục tiêu: giảm cân, tăng cân, tăng cơ, duy trì sức khỏe")
    ...
    activity_level: Optional[str] = Field(None, description="Mức độ hoạt động: sedentary, light, moderate, active, very_active")
